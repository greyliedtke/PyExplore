...
s0 = ServoClass(board.GP0, 180, 135)
s1 = ServoClass(board.GP1, 0, 1)
s2 = ServoClass(board.GP2, 0, 1)
s3 = ServoClass(board.GP3, 0, 1)
s4 = ServoClass(board.GP4, 0, 1)
s5 = ServoClass(board.GP5, 0, 1)
s6 = ServoClass(board.GP6, 0, 1)
